...
'''Runs the simulation with 1 ray down the center axis. power is simulated without pixels.'''
...
'''Runs one ray through the simulation, random phase, random launch angle. to show geometric loss '''
